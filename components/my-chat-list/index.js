...
class MyChatList extends HTMLElement {
  ...
  get itemElements() {
    return Array.from(this.listElement.querySelectorAll('q-chat-item'))
  }

  addItem(item) {
    const itemElement = document.createElement('q-chat-item')
  ...
  render() {
    this.innerHTML = ''
    this.listElement = document.createElement('q-chat-list')
...
customElements.define('my-chat-list', MyChatList)
